...
from ...utils import box_coder_utils, common_utils, loss_utils, mimic_loss_utils
    ...
    def build_soft_losses(self, soft_losses_cfg):
        ...
        if self.cls_soft_loss_type is not None:
            ...
            if self.cls_soft_loss_type in ['SigmoidFocalClassificationLoss', 'SigmoidFocalLoss']:
                ...
                self.add_module(
                    'soft_cls_loss_func',
                     getattr(mimic_loss_utils, self.cls_soft_loss_type)(weighted=weighted, T=mimic_cls_temperature)
                    )
            else:
                self.add_module(
                    'soft_cls_loss_func',
