...
def train_model_cross_dataset(model, optimizer, train_loader, train_loader_dataset2, model_func, lr_scheduler, optim_cfg,
                ...
                train_sampler_dataset2=None): # elodie teacher model
    accumulated_iter = start_iter
    with tqdm.trange(start_epoch, total_epochs, desc='epochs', dynamic_ncols=True, leave=(rank == 0)) as tbar:
        total_it_each_epoch = len(train_loader) + len(train_loader_dataset2)
        ...
        for cur_epoch in tbar:
            ...
            accumulated_iter = train_one_epoch_cross_dataset(
                model, optimizer, train_loader, train_loader_dataset2, model_func,
