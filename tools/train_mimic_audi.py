...
from train_utils.train_utils_cross_dataset import train_model_cross_dataset
from pathlib import Path
import yaml
...
def main():
    ...
    train_set_dataset2, train_loader_dataset2, train_sampler_dataset2 = build_dataloader(
    ...
    lr_scheduler, lr_warmup_scheduler = build_scheduler(
        optimizer, total_iters_each_epoch=len(train_loader)+len(train_loader_dataset2), total_epochs=args.epochs,
    ...
    train_model_cross_dataset(
        model,
        optimizer,
        train_loader,
        train_loader_dataset2=train_loader_dataset2, 
        ...
        train_sampler_dataset2=train_sampler_dataset2,
